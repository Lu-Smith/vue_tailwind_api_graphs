...
<template>
  ...
  <div class="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
    <h2 class="text-center text-base/7 font-semibold text-indigo-600">{{ pokemonData?.name.toUpperCase() }} is here!</h2>
    <p class="mx-auto mt-2 max-w-lg text-balance text-center text-4xl font-semibold tracking-tight text-gray-950 sm:text-5xl">Everything you need to know about your pokemon.</p>
    <div class="mt-10 grid gap-4 sm:mt-16 lg:grid-cols-3 lg:grid-rows-2">
      <div class="relative lg:row-span-2">
        ...
        <div class="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] lg:rounded-l-[calc(2rem+1px)]">
          <div class="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
            <p class="mt-2 text-lg font-medium tracking-tight text-gray-950 max-lg:text-center">Abilities</p>
            <ul class="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
      ...
      <div class="relative max-lg:row-start-1">
        ...
        <div class="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-t-[calc(2rem+1px)]">
          <div class="px-8 pt-8 sm:px-10 sm:pt-10">
            <p class="mt-2 text-lg font-medium tracking-tight text-gray-950 max-lg:text-center">Type</p>
            <p class="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">{{ pokemonData?.types[0].type.name }}</p>
          </div>
      ...
      <div class="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2">
        ...
        <div class="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)]">
          <div class="px-8 pt-8 sm:px-10 sm:pt-10">
            <p class="mt-2 text-lg font-medium tracking-tight text-gray-950 max-lg:text-center">Moves</p>
            <p class="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">{{ pokemonData?.moves[0].move.name}}</p>
          </div>
      ...
      <div class="relative lg:row-span-2">
        ...
        <div class="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)]">
          <div class="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
            <p class="mt-2 text-lg font-medium tracking-tight text-gray-950 max-lg:text-center">Weight</p>
            <p class="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">{{ pokemonData?.weight }}kg</p>
          </div>
